...
let familyNames = ["Aidan", "Owen", "Beckett", "Kelli", "Jay"]

let sortedCollection1 = familyNames.sorted(by: forwards)
...
let backwards = {(name1: String, name2: String) -> Bool in
return name1 > name2
}

let sortedCollection2 = familyNames.sorted(by: backwards)
...
let sortedCollection3 = familyNames.sorted {$0 < $1}
